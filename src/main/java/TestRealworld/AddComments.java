...
public class AddComments {
	...
	public static void main(String[] args) {
		...
		// driver.findElement(By.xpath("//input[@type=\'password\']")).click();
		 ...
		 //driver.findElement(By.cssSelector("app-article-preview:nth-child(1) h1")).click();
		 driver.findElement(By.cssSelector(".form-control")).click();
	     driver.findElement(By.cssSelector(".form-control")).sendKeys("fdff");
		 driver.findElement(By.className("btn btn-sm btn-primary")).click();
		// driver.findElement(By.cssSelector(".mod-options > .ion-trash-a")).click();
